            ...
            <main className="min-h-screen lg:mb-[-100px]   text-white">
                <div className="flex flex-col items-center justify-center py-12 px-4 md:px-8 lg:px-24">
                    ...
                    <form className="w-full max-w-xl space-y-4 ">
                        ...
                        <div>
                            <label className="block text-xs mb-1" htmlFor="phone">Phone number</label>
                            <input
                                id="phone"
                                type="text"
                        ...
                        <div>
                            <label className="block text-xs mb-1" htmlFor="message">Message</label>
                            <textarea
                                id="message"
                        ...
                        <div className="text-center">
                            <button
                                type="submit"
                                className="bg-[#1e2d2d] text-white py-2 px-8 rounded border border-white hover:bg-[#294040] transition"
                            >
                                SEND MESSAGE
                            </button>
                        </div>
